package com.rolinsf.novelbackend.config;
...
@SecurityScheme(type = SecuritySchemeType.APIKEY, in = SecuritySchemeIn.HEADER, name = SystemConfigConst.HTTP_AUTH_HEADER_NAME, description = "登录 token")
